...
<%--            background-color: var(--main-color); /* Đồng nhất màu */--%>
<%--            display: flex;--%>
<%--            align-items: center;--%>
...
<%--            padding-right: 25px; /* Tăng padding để đẹp hơn */--%>
<%--            font-size: 1em; /* Kích thước phù hợp hơn */--%>
<%--            font-weight: bold;--%>
<%--        }--%>
...
<%--                    <form id="importForm" action="ImportDataServlet" method="POST" enctype="multipart/form-data" style="display: inline-flex; align-items: center;">--%>

<%--                        <input type="file" id="importFile" name="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" style="display: none;">--%>

<%--                        <button type="button" id="btnImportTrigger" style="--%>
<%--                                background-color: var(--main-color);--%>
<%--                                color: white;--%>
<%--                                padding: 8px 15px;--%>
<%--                                border: none;--%>
...
<%--                                font-size: 0.95em;--%>
<%--                                transition: background-color 0.3s;"--%>
<%--                                title="Click to choose a file and import data">--%>
...
<%--                &lt;%&ndash; Dữ liệu thật từ Controller &ndash;%&gt;--%>
...
<%--                &lt;%&ndash; Trường hợp không có dữ liệu ban đầu &ndash;%&gt;--%>
