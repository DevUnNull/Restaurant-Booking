                    ...
                    <div class="modal-content">
                        ...
                        <form action="ServiceAdd" method="post">
                            ...
                            <input type="text" id="add-code" name="serviceCode" 
                                   value="${param.serviceCode != null ? param.serviceCode : ''}" >
    ...
    <div id="updateModal" class="modal">
        <div class="modal-content">
            ...
            <form action="ServiceUpdate" method="post">
                <input type="hidden" id="update-id" name="serviceId">

                <label>Tên dịch vụ:</label>
                <input type="text" id="update-name" name="serviceName">
                ...
                <label>Ngày bắt đầu:</label>
                <input type="date" id="update-start" name="startDate">

                <label>Ngày kết thúc:</label>
                <input type="date" id="update-end" name="endDate">
